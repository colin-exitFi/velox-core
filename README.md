...
Velox Core lives or dies on a single comparison: **its 30-day equity curve vs SPY's 30-day equity curve over the same window.**
...
If at day 30 Velox Core has not beaten SPY, it gets killed. No tuning marathon. No "we just need to add this one feed." Kill, learn, fork, try the next architecture.
